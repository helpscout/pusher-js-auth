...
(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    ...
    // like Node.
    module.exports = factory(require('pusher-js/dist/worker/pusher.worker').PusherWorker);
  } else if (typeof define === 'function' && define.amd) {
    // AMD. Register as an anonymous module.
    define(['pusher-js/dist/worker/pusher.worker'], function (mod) { return factory(mod.PusherWorker) });
  } else {
    // Browser globals (root is window)
    root.PusherBatchAuthorizer = factory(root.PusherWorker);
  }
